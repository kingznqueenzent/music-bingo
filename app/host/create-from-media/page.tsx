  ...
  return (
    <main className="min-h-dvh w-full overflow-x-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-3 sm:px-6 pt-6">
        <Link href="/host" className="text-slate-300 hover:text-white text-sm min-h-11 inline-flex items-center">
          ← Back to Host
        </Link>
      </div>
      <section className="max-w-4xl mx-auto px-3 sm:px-6 py-6 sm:py-8">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold mb-2 text-slate-100">
